locals {
  ...
  spryker_ecs_services      = ["frontend", "yves", "glue", "boffice", "backapi", "backgw", "rabbitmq", "blackfire", "mportal"] // full list of enabled ecs services
  ...
  monitoring_services       = ["newrelic-host-agent", "newrelic-rabbitmq-monitoring"] // this is constant value used in spryker_services when newrelic enable_producation_mode set to true
