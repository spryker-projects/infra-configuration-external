...
locals {
  spryker_service = read_terragrunt_config(find_in_parent_folders("config/spryker-services/ecs_service-frontend.hcl"))
...
inputs = {
  ...
  subnets                            = dependency.vpc.outputs.private_dmz_subnet_ids
