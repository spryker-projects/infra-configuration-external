...
inputs = {
  ...
  codebuild_projects_config = {
    "post_deploy" = {
      namebase             = local.codebuild-project.locals.codebuild_projects_config.post_deploy.namebase
      description          = local.codebuild-project.locals.codebuild_projects_config.post_deploy.description
      build_timeout        = local.codebuild-project.locals.codebuild_projects_config.post_deploy.build_timeout
      service_role_arn     = dependency.iam_role.outputs.codebuild_role_arn
      artifacts            = local.codebuild-project.locals.codebuild_projects_config.post_deploy.artifacts
      secondary_artifact   = null
      secondary_sources    = null
      cache_config         = local.codebuild-project.locals.codebuild_projects_config.post_deploy.cache_config
      source_template      = local.codebuild-project.locals.codebuild_projects_config.post_deploy.source_template
      source_template_vars = local.codebuild-project.locals.codebuild_projects_config.post_deploy.source_template_vars
      source_type          = local.codebuild-project.locals.codebuild_projects_config.post_deploy.source_type
      environment_config = {
        compute_type                = local.codebuild-project.locals.codebuild_projects_config.post_deploy.environment_config.compute_type
        image                       = dependency.ecr.outputs.repository_urls["boffice"]
        image_pull_credentials_type = local.codebuild-project.locals.codebuild_projects_config.post_deploy.environment_config.image_pull_credentials_type
        type                        = local.codebuild-project.locals.codebuild_projects_config.post_deploy.environment_config.type
        privileged_mode             = local.codebuild-project.locals.codebuild_projects_config.post_deploy.environment_config.privileged_mode
        registry_credential         = local.codebuild-project.locals.codebuild_projects_config.post_deploy.environment_config.registry_credential
