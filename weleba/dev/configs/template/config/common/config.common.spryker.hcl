locals {
  ...
  spryker_ecs_services      = ['glue', 'glue-storefront', 'glue-backend', 'boffice', 'backgw', 'frontend', 'rabbitmq', 'blackfire'] // full list of enabled ecs services
  ...
  services_to_restart       = ['glue', 'glue-storefront', 'glue-backend', 'boffice', 'backgw', 'frontend']
  spryker_ecr_repos         = ['glue', 'glue-storefront', 'glue-backend', 'boffice', 'backgw', 'frontend', 'rabbitmq', 'blackfire', 'jenkins', 'pipeline'] # pipeline repository is obligatory starting from 6.0, docker/sdk produces image inside of it
  region                    = "eu-central-1"
