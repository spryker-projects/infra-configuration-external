locals {
  ...
  spryker_ecs_services      = ['mportal', 'glue', 'glue-storefront', 'glue-backend', 'boffice', 'backgw', 'frontend', 'rabbitmq', 'blackfire'] // full list of enabled ecs services
  ...
  services_to_restart       = ['mportal', 'glue', 'glue-storefront', 'glue-backend', 'boffice', 'backgw', 'frontend']
  spryker_ecr_repos         = ['mportal', 'glue', 'glue-storefront', 'glue-backend', 'boffice', 'backgw', 'frontend', 'rabbitmq', 'blackfire', 'jenkins', 'pipeline'] # pipeline repository is obligatory starting from 6.0, docker/sdk produces image inside of it
  region                    = "eu-central-1"
